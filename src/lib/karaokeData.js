    ...
    sections: [
      {
        ...
        lines: [
          { text: "Todas las veces que decía", start: 12, end: 20.2 },
          { text: "que comas toda la comida", start: 20.2, end: 24.2 },
          { text: "todas las veces que un dulce te negué", start: 24.2, end: 30.2 },
          { text: "era por tu propio bien", start: 30.2, end: 33.9 },
          { text: "Cada vez que te mandaba", start: 33.9, end: 37.6 },
          { text: "a ponerte más abrigo", start: 37.6, end: 40.9 },
          { text: "por más que vos no sientas", start: 40.9, end: 45.2 },
          { text: "que hace frío abrigate igual", start: 45.2, end: 49.8 },
          { text: "o te podés enfermar", start: 49.8, end: 52.9 },
          { text: "vestite, bañate, abrigate", start: 52.9, end: 57.0 },
          { text: "lavate los dientes, andá a peinarte", start: 57.0, end: 62.8 },
          { text: "ordená tu cuarto, acostate", start: 62.8, end: 67.1 },
          { text: "levantate, se hace tarde", start: 67.1, end: 71.0 },
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        lines: [
          { text: "Azul azul", start: 78, end: 87.5 },
          { text: "azul azul", start: 87.5, end: 97 },
          { text: "Azul con amarillo da verde, como el color de un melón", start: 97, end: 104.3 },
          { text: "Azul con rojo es morado, como un tomate en mal estado", start: 104.3, end: 111.4 },
          { text: "Rojo y amarillo, es anaranjado", start: 111.4, end: 116.0 },
