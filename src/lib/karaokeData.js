    ...
    sections: [
      {
        ...
        lines: [
          { text: "Me dijeron que en el Reino del Revés", start: 24, end: 27 },
          { text: "Nada el pájaro y vuela el pez", start: 27, end: 30 },
          { text: "Que los gatos no hacen miau y dicen yes", start: 30, end: 34 },
          { text: "Porque estudian mucho inglés", start: 34, end: 37 },
          { text: "Vamos a ver cómo es", start: 37, end: 40 },
          { text: "El Reino del Revés", start: 40, end: 43 },
          { text: "Vamos a ver cómo es", start: 43, end: 45.5 },
          { text: "El Reino del Revés", start: 45.5, end: 48 },
          { text: "Me dijeron que en el Reino del Revés", start: 48, end: 51 },
          { text: "Nadie baila con los pies", start: 51, end: 54 },
          { text: "Que un ladrón es vigilante y otro es juez", start: 54, end: 57.5 },
          { text: "Y que dos y dos son tres", start: 57.5, end: 61 },
          { text: "Vamos a ver cómo es", start: 61, end: 64 },
          { text: "El Reino del Revés", start: 64, end: 67 },
          { text: "Vamos a ver cómo es", start: 67, end: 70.5 },
          { text: "El Reino del Revés", start: 70.5, end: 74 },
          { text: "Me dijeron que en el Reino del Revés", start: 74, end: 76.5 },
          { text: "Cabe un oso en una nuez", start: 76.5, end: 79 },
          { text: "Que usan barbas y bigotes los bebés", start: 79, end: 82.5 },
          { text: "Y que un año dura un mes", start: 82.5, end: 86 },
          { text: "Vamos a ver cómo es", start: 86, end: 88.5 },
          { text: "El Reino del Revés", start: 88.5, end: 91 },
          { text: "Vamos a ver cómo es", start: 91, end: 94 },
          { text: "El Reino del Revés", start: 94, end: 97 },
        ],
      },
      {
        intro: { title: "SOLO DE GUITARRA", message: "¡¡Y todos a bailar!!", emoji: "🎸", start: 97, end: 135.2 },
        lines: [
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        lines: [
          { text: "Yo solo soy", start: 12, end: 17 },
          { text: "Un pequeño pajarito", start: 17, end: 23 },
          { text: "Alejado del montón", start: 23, end: 29 },
          { text: "Todos volando menos yo", start: 29, end: 34 },
          { text: "Y acá estoy", start: 34, end: 40 },
          { text: "Entre los dedos de un chabón", start: 40, end: 45 },
          { text: "No me quiere soltar", start: 45, end: 51 },
          { text: "Se la quiere asegurar", start: 51, end: 55 },
          { text: "Y yo extraño a mi bandada", start: 55, end: 61 },
          { text: "Volar el cielo en libertad", start: 61, end: 67 },
          { text: "Recorrer el mundo", start: 67, end: 72 },
          { text: "Volando siempre en libertad", start: 72, end: 77 },
        ],
      },
      {
        intro: { title: "VOLEMOS", message: "¡¡Tomemos aire!!", emoji: "🐦", start: 77, end: 89 },
        lines: [
          { text: "Es mejor pájaro en mano", start: 89, end: 95 },
          { text: "Que cien pájaros volando", start: 95, end: 100 },
          { text: "Nadie pensó en mí", start: 100, end: 105 },
          { text: "Cuando inventaron el refrán", start: 105, end: 110 },
          { text: "Y yo extraño a mi bandada", start: 110, end: 116 },
          { text: "Volar el cielo en libertad", start: 116, end: 122 },
          { text: "Recorrer el mundo", start: 122, end: 127 },
          { text: "Volando siempre en libertad", start: 127, end: 132 },
        ],
      },
      {
        intro: { title: "SOLO DE GUITARRA", message: "¡¡Hagamos que volamos!!", emoji: "🎸", start: 132, end: 160 },
        lines: [
          { text: "Y yo extraño a mi bandada", start: 160, end: 165 },
          { text: "Volar el cielo en libertad", start: 165, end: 171 },
          { text: "Recorrer el mundo", start: 171, end: 177 },
          { text: "Volando siempre en libertad", start: 177, end: 182 },
          { text: "Oh oh oh oh oh", start: 182, end: 187 },
          { text: "ooooohh en libertad", start: 187, end: 192 },
          { text: "Oh oh oh oh oh", start: 192, end: 197 },
          { text: "ooooohh en libertad", start: 197, end: 200.2 },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        lines: [
          { text: "Cuántos dichos hemos dicho", start: 18, end: 22 },
          { text: "Sin medir las consecuencias", start: 22, end: 26 },
          { text: "Como la historia de mi amigo", start: 26, end: 30.5 },
          { text: "Dueño de un caballo que le regaló el patrón", start: 30.5, end: 35 },
          { text: "Hoy al caballo se le aflojó un diente", start: 35, end: 39 },
          { text: "Ningún veterinario lo quiere mirar", start: 39, end: 43 },
          { text: "Porque a caballo regalado no se le miran los dientes", start: 43, end: 51 },
          { text: "Que aparezca un veterinario que lo pueda ayudar", start: 51, end: 59 },
        ],
      },
      {
        intro: { title: "MELO DE GUITARRA", message: "¡¡Bailemos!!", emoji: "🎸", start: 59, end: 76 },
        lines: [
          { text: "Otra opción es venderlo al pingo", start: 76, end: 79 },
          { text: "Que de caballo vendido no hay refrán", start: 79, end: 82 },
          { text: "Pero a un caballo con dolor de dientes", start: 82, end: 86 },
          { text: "Nadie lo quiere comprar", start: 86, end: 90 },
          { text: "Voy a tener que regalarlo", start: 90, end: 94.5 },
          { text: "Creo que ya entiendo de dónde es el refrán", start: 94.5, end: 99 },
          { text: "Porque a caballo regalado no se le miran los dientes", start: 99, end: 105 },
          { text: "Que aparezca un veterinario que lo pueda ayudar", start: 105, end: 111 },
        ],
      },
      {
        intro: { title: "SOLO DE GUITARRA", message: "¡¡Todo el mundo a saltar!!", emoji: "🎸", start: 111, end: 123 },
        lines: [
          { text: "Que aparezca un veterinario", start: 122, end: 126 },
          { text: "Que pueda ayudar a mi caballo", start: 126, end: 130 },
          { text: "Porque a un caballo con dolor de dientes", start: 130, end: 133 },
          { text: "Nadie lo quiere mirar", start: 133, end: 136 },
          { text: "Voy a tener que regalarlo", start: 136, end: 140.5 },
          { text: "Creo que ya entiendo de dónde es el refrán", start: 140.5, end: 145 },
        ],
      },
    ],
  },
