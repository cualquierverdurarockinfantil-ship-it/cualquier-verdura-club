    ...
    sections: [
      {
        ...
        lines: [
          ...
          { text: "Vamos a ver cómo es", start: 37, end: 42.5 },
          { text: "El Reino del Revés", start: 42.5, end: 48 },
          { text: "Vamos a ver cómo es", start: 48.5, end: 51 },
          { text: "El Reino del Revés", start: 51, end: 54 },
          { text: "Me dijeron que en el Reino del Revés", start: 54, end: 57.5 },
          { text: "Nadie baila con los pies", start: 57.5, end: 61 },
          { text: "Que un ladrón es vigilante y otro es juez", start: 61, end: 64.3 },
          { text: "Y que dos y dos son tres", start: 64.3, end: 67 },
          ...
          { text: "Vamos a ver cómo es", start: 86, end: 91.5 },
          { text: "El Reino del Revés", start: 91.5, end: 97 },
        ],
      },
      {
    ...
    sections: [
      {
        ...
        lines: [
          { text: "Yo solo soy", start: 12, end: 15 },
          { text: "Un pequeño pajarito", start: 17, end: 21 },
          { text: "Alejado del montón.", start: 23, end: 26 },
          { text: "Todos volando menos yo.", start: 29, end: 32 },
          { text: "Y acá estoy", start: 34, end: 38 },
          { text: "Entre los dedos de un chabón.", start: 40, end: 43 },
          { text: "No me quiere soltar,", start: 45, end: 49 },
          { text: "Se la quiere asegurar.", start: 51, end: 54 },
          { text: "Y yo extraño a mi bandada.", start: 55, end: 60 },
          { text: "Volar el cielo en libertad.", start: 61, end: 65 },
          { text: "Recorrer el mundo.", start: 67, end: 71 },
      ...
      },
      {
        ...
        lines: [
          { text: "Es mejor pájaro en mano", start: 89, end: 94 },
          { text: "Que cien pájaros volando.", start: 95, end: 99 },
          { text: "Nadie pensó en mí.", start: 100, end: 104 },
          { text: "Cuando inventaron el refrán.", start: 105, end: 109 },
          { text: "Y yo extraño a mi bandada.", start: 110, end: 116 },
          { text: "Volar el cielo en libertad.", start: 116, end: 120 },
          { text: "Recorrer el mundo.", start: 122, end: 126 },
      ...
      },
      {
        ...
        lines: [
          { text: "Y yo extraño a mi bandada.", start: 160, end: 164 },
          { text: "Volar el cielo en libertad.", start: 165, end: 170 },
          { text: "Recorrer el mundo.", start: 171, end: 175 },
          { text: "Volando siempre en libertad.", start: 175, end: 177 },
          { text: "Oh oh oh oh oh", start: 177, end: 180 },
          { text: "ooooohh en libertad", start: 182, end: 186 },
          { text: "Oh oh oh oh oh", start: 187, end: 191 },
          { text: "ooooohh en libertad", start: 192, end: 197 },
        ],
      },
    ],
  },
