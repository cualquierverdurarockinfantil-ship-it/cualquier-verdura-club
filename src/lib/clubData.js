...
export const ALBUM = {
  ...
  tracks: [
    { id: 1,  title: "Rock & Colors",          composer: "Cualquier Verdura",                duration: "", character: "zanahoria", lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/rock-and-colors.pdf" },
    { id: 2,  title: "Dulces",                 composer: "Village People / adaptación",      duration: "", character: "berenjena", lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/dulces.pdf" },
    { id: 3,  title: "Super Poder",            composer: "Cualquier Verdura",                duration: "", character: "tomate",    lyrics: "", description: "", chordsPdfUrl: null },
    { id: 4,  title: "Así Asá",               composer: "Cualquier Verdura",                duration: "", character: "choclo",    lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/asi-asa.pdf" },
    { id: 5,  title: "El Baile de los Piojos", composer: "Arte popular / adaptación",        duration: "", character: "cebolla",   lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/el-baile-de-los-piojos.pdf" },
    { id: 6,  title: "Se Hace Tarde",          composer: "Cualquier Verdura",                duration: "", character: "brocoli",   lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/se-hace-tarde.pdf" },
    { id: 7,  title: "Caballo Regala'o",       composer: "Cualquier Verdura",                duration: "", character: "calabaza",  lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/caballo-regalao.pdf" },
    { id: 8,  title: "Pájaros Volando",        composer: "Cualquier Verdura",                duration: "", character: "rabanito",  lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/pajaros-volando.pdf" },
    { id: 9,  title: "El Reino del Revés",     composer: "María Elena Walsh / versión",      duration: "", character: "tomate",    lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/el-reino-del-reves.pdf" },
  ],
};
