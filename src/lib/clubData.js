...
export const ALBUM = {
  ...
  tracks: [
    { id: 1,  title: "Rock & Colors",          composer: "Cualquier Verdura",                duration: "", character: "zanahoria", lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/rock-and-colors.pdf", audioOriginal: "/assets/audio/album/rock-and-colors-voz.mp3", audioInstrumental: "/assets/audio/album/rock-and-colors-instrumental.mp3" },
    { id: 2,  title: "Dulces",                 composer: "Village People / adaptación",      duration: "", character: "berenjena", lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/dulces.pdf", audioOriginal: "/assets/audio/album/dulces-voz.mp3", audioInstrumental: "/assets/audio/album/dulces-instrumental.mp3" },
    { id: 3,  title: "Súper Poder",            composer: "Cualquier Verdura",                duration: "", character: "tomate",    lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/super-poder.pdf", audioOriginal: "/assets/audio/album/super-poder-voz.mp3", audioInstrumental: "/assets/audio/album/super-poder-instrumental.mp3" },
    { id: 4,  title: "Así Asá",               composer: "Cualquier Verdura",                duration: "", character: "choclo",    lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/asi-asa.pdf", audioOriginal: "/assets/audio/album/asi-asa-voz.mp3", audioInstrumental: "/assets/audio/album/asi-asa-instrumental.mp3" },
    { id: 5,  title: "El Baile de los Piojos", composer: "Arte popular / adaptación",        duration: "", character: "cebolla",   lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/el-baile-de-los-piojos.pdf", audioOriginal: "/assets/audio/album/el-baile-de-los-piojos-voz.mp3", audioInstrumental: "/assets/audio/album/el-baile-de-los-piojos-instrumental.mp3" },
    { id: 6,  title: "Se Hace Tarde",          composer: "Cualquier Verdura",                duration: "", character: "brocoli",   lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/se-hace-tarde.pdf", audioOriginal: "/assets/audio/album/se-hace-tarde-voz.mp3", audioInstrumental: "/assets/audio/album/se-hace-tarde-instrumental.mp3" },
    { id: 7,  title: "Caballo Regalado",       composer: "Cualquier Verdura",                duration: "", character: "calabaza",  lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/caballo-regalado.pdf", audioOriginal: "/assets/audio/album/caballo-regalado-voz.mp3", audioInstrumental: "/assets/audio/album/caballo-regalado-instrumental.mp3" },
    { id: 8,  title: "Pájaros Volando",        composer: "Cualquier Verdura",                duration: "", character: "rabanito",  lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/pajaros-volando.pdf", audioOriginal: "/assets/audio/album/pajaros-volando-voz.mp3", audioInstrumental: "/assets/audio/album/pajaros-volando-instrumental.mp3" },
    { id: 9,  title: "El Reino del Revés",     composer: "María Elena Walsh / versión",      duration: "", character: "tomate",    lyrics: "", description: "", chordsPdfUrl: "/assets/acordes/el-reino-del-reves.pdf", audioOriginal: "/assets/audio/album/el-reino-del-reves-voz.mp3", audioInstrumental: "/assets/audio/album/el-reino-del-reves-instrumental.mp3" },
  ],
};
...
export const VIDEOS = [
  {
    ...
    description: "Videoclip oficial de Un Buen Plan.",
  },
  {
    id: 2,
    ...
    description: "Videoclip oficial de La Gran Manada.",
  },
  {
    id: 3,
    title: "La Tortuga Manuelita: Vivo",
    type: "vivo",
    thumbnail: "/assets/fondo-plaza.jpg",
    youtubeId: "",
    youtubeUrl: "https://www.youtube.com/watch?v=aqQtTjzKpuA",
    description: "Versión en vivo de La Tortuga Manuelita.",
  },
  {
    id: 4,
    title: "El Monstruo de la Laguna: Vivo",
    type: "vivo",
    thumbnail: "/assets/fondo-plaza.jpg",
    youtubeId: "",
    youtubeUrl: "https://www.youtube.com/watch?v=JCSV2fn4-cU",
    description: "Versión en vivo de El Monstruo de la Laguna — Tacuarock.",
  },
  {
    id: 5,
    title: "Ricardito: Vivo",
    type: "vivo",
    thumbnail: "/assets/fondo-plaza.jpg",
    youtubeId: "",
    youtubeUrl: "https://youtu.be/kO3jJpKbJTU",
    description: "Versión en vivo de Ricardito.",
  },
];
